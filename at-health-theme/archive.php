...
/**
 * Archive Template
 * Category and date archive listings for Health Hub.
 */
get_header();
?>
...
<main style="background: var(--ah-cream);">
    <section class="ah-container-wide py-16 md:py-24">
        <div class="text-center mb-12">
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-serif text-gray-900 mb-4">
                <?php the_archive_title(); ?>
            </h1>
            <?php the_archive_description( '<p class="text-lg text-gray-600 max-w-2xl mx-auto">', '</p>' ); ?>
        </div>
        ...
        <?php else : ?>
            <p class="text-center text-gray-500 text-lg">No articles found.</p>
        <?php endif; ?>
    </section>
</main>
