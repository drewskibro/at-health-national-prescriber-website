    ...
    <div class="max-w-[900px] mx-auto px-6 md:px-[60px] relative z-10">
      ...
      <div class="text-center mt-10" data-reveal>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="<?php echo esc_url( ah_phone_link() ); ?>" class="inline-flex items-center gap-2 text-purple-600 font-semibold text-base hover:text-purple-700 transition-colors">
